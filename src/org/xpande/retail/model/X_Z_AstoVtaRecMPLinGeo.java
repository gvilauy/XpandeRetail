...
/** Generated Model for Z_AstoVtaRecMPLinGeo
 *  @author Adempiere (generated) 
 *  @version Release 3.9.1 - $Id$ */
public class X_Z_AstoVtaRecMPLinGeo extends PO implements I_Z_AstoVtaRecMPLinGeo, I_Persistent 
{
    ...
    public X_Z_AstoVtaRecMPLinGeo (Properties ctx, int Z_AstoVtaRecMPLinGeo_ID, String trxName)
    {
      super (ctx, Z_AstoVtaRecMPLinGeo_ID, trxName);
      /** if (Z_AstoVtaRecMPLinGeo_ID == 0)
        {
...
// Y
			...
			setZ_AstoVtaRecMPLinGeo_ID (0);
			setZ_GenAstoVtaDetMPGeo_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_AstoVtaRecMPLinGeo (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_AstoVtaRecMPLinGeo[")
	...
	/** Set Z_AstoVtaRecMPLinGeo ID.
		@param Z_AstoVtaRecMPLinGeo_ID Z_AstoVtaRecMPLinGeo ID	  */
	public void setZ_AstoVtaRecMPLinGeo_ID (int Z_AstoVtaRecMPLinGeo_ID)
	{
		if (Z_AstoVtaRecMPLinGeo_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_AstoVtaRecMPLinGeo_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_AstoVtaRecMPLinGeo_ID, Integer.valueOf(Z_AstoVtaRecMPLinGeo_ID));
	}

	/** Get Z_AstoVtaRecMPLinGeo ID.
		@return Z_AstoVtaRecMPLinGeo ID	  */
	public int getZ_AstoVtaRecMPLinGeo_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_AstoVtaRecMPLinGeo_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_Z_GenAstoVtaDetMPGeo)MTable.get(getCtx(), I_Z_GenAstoVtaDetMPGeo.Table_Name)
			.getPO(getZ_GenAstoVtaDetMPGeo_ID(), get_TrxName());	}
	...
	public void setZ_GenAstoVtaDetMPGeo_ID (int Z_GenAstoVtaDetMPGeo_ID)
	{
		if (Z_GenAstoVtaDetMPGeo_ID < 1) 
			set_Value (COLUMNNAME_Z_GenAstoVtaDetMPGeo_ID, null);
		else 
			set_Value (COLUMNNAME_Z_GenAstoVtaDetMPGeo_ID, Integer.valueOf(Z_GenAstoVtaDetMPGeo_ID));
	}
