...
public class X_Z_RemitoDifInv extends PO implements I_Z_RemitoDifInv, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_RemitoDifInv (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_RemitoDifInv[")
	...
	public void setZ_RemitoDifInv_ID (int Z_RemitoDifInv_ID)
	{
		if (Z_RemitoDifInv_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_RemitoDifInv_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_RemitoDifInv_ID, Integer.valueOf(Z_RemitoDifInv_ID));
	}
