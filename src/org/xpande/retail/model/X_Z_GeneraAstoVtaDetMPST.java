...
/** Generated Model for Z_GeneraAstoVtaDetMPST
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_GeneraAstoVtaDetMPST extends PO implements I_Z_GeneraAstoVtaDetMPST, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20190802L;

    /** Standard Constructor */
    public X_Z_GeneraAstoVtaDetMPST (Properties ctx, int Z_GeneraAstoVtaDetMPST_ID, String trxName)
    {
      super (ctx, Z_GeneraAstoVtaDetMPST_ID, trxName);
      /** if (Z_GeneraAstoVtaDetMPST_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_Z_GeneraAstoVtaDetMPST (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_GeneraAstoVtaDetMPST[")
	...
	public void setZ_GeneraAstoVtaDetMPST_ID (int Z_GeneraAstoVtaDetMPST_ID)
	{
		if (Z_GeneraAstoVtaDetMPST_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_GeneraAstoVtaDetMPST_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_GeneraAstoVtaDetMPST_ID, Integer.valueOf(Z_GeneraAstoVtaDetMPST_ID));
	}
