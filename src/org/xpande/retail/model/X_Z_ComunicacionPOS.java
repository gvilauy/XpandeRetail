...
public class X_Z_ComunicacionPOS extends PO implements I_Z_ComunicacionPOS, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_ComunicacionPOS (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_ComunicacionPOS[")
	...
	public void setZ_ComunicacionPOS_ID (int Z_ComunicacionPOS_ID)
	{
		if (Z_ComunicacionPOS_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_ComunicacionPOS_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_ComunicacionPOS_ID, Integer.valueOf(Z_ComunicacionPOS_ID));
	}
