...
// N
    ...
    /** Load Constructor */
    public X_Z_ActualizacionPVP (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_ActualizacionPVP[")
	...
	public void setZ_ActualizacionPVP_ID (int Z_ActualizacionPVP_ID)
	{
		if (Z_ActualizacionPVP_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_ActualizacionPVP_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_ActualizacionPVP_ID, Integer.valueOf(Z_ActualizacionPVP_ID));
	}
