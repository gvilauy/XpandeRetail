...
/** Generated Model for Z_ProductoFamilia
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_ProductoFamilia extends PO implements I_Z_ProductoFamilia, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_Z_ProductoFamilia (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_ProductoFamilia[")
	...
	public void setZ_ProductoFamilia_ID (int Z_ProductoFamilia_ID)
	{
		if (Z_ProductoFamilia_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_ProductoFamilia_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_ProductoFamilia_ID, Integer.valueOf(Z_ProductoFamilia_ID));
	}
